...
Rails.application.configure do
  ...
  config.action_mailer.default_url_options = { host: "utilsawesome.com", protocol: "https" }

  # Set host to be used by links generated in controllers and views.
  config.action_controller.default_url_options = { host: "utilsawesome.com", protocol: "https" }
